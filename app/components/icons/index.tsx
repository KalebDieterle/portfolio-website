// Shared icon components for the portfolio
...
export const CodeIcon = ({ className = "w-5 h-5 text-cyan-400" }: { className?: string }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const BriefcaseIcon = ({ className = "w-7 h-7 text-white" }: { className?: string }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const getContactIcon = (type: "email" | "github" | "linkedin") => {
  switch (type) {
    case "email":
      return <EmailIcon />;
    case "github":
